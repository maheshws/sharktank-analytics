...
console.log(data)
  var x = d3.scaleBand()
      ...
      .domain(data.map(function(d) { return d.category })); // The domain of the X axis is the list of states.
  ...
  svg.append("g")
    ...
    .append("path")
      ...
      .attr("d", d3.arc()     // imagine your doing a part of a donut plot
          ...
          .outerRadius(function(d) { return y(d.reviews); })
  ...
  svg.append("g")
      ...
      .append("g")
        ...
        .attr("transform", function(d) { return "rotate(" + ((x(d.category) + x.bandwidth() / 2) * 180 / Math.PI - 90) + ")"+"translate(" + (y(d.reviews)+10) + ",0)"; })
        //.attr("transform", function(d) { return "rotate(" + ((x(d.category) + x.bandwidth() / 2) * 180 / Math.PI - 90) + ")"+"translate(0,0)"; })
      .append("text")
        .text(function(d){return(data.forEach(data => data.category))})
  ...
  svg.append("g")
    ...
    .append("path")
      ...
      .attr("d", d3.arc()     // imagine your doing a part of a donut plot
          ...
          .outerRadius( function(d) { return ybis([d.reviews]); })
          .startAngle(function(d) { return x(d.category); })
          .endAngle(function(d) { return x(d.category) + x.bandwidth(); })
          .padAngle(0.01)
          .padRadius(innerRadius))
